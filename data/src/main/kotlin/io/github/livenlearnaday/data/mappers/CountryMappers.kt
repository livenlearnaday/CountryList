...
fun CountryDto.toCountryModel(): CountryModel = CountryModel(
    name = this.name,
...
fun CountryEntity.toCountryModel(): CountryModel = CountryModel(
    id = this.id,
    name = this.name,
    capital = this.capital,
    region = this.region,
...
fun List<CountryModel>.toCountryEntities(): List<CountryEntity> = this.map { country ->
    CountryEntity(
        name = country.name,
...
fun CountryModel.toCountryEntity(): CountryEntity = CountryEntity(
    name = this.name,
    capital = this.capital,
    region = this.region,
    subregion = this.subregion,
